...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="<?php echo e(route('folders.store', ['rpg_hash' => $rpg->hash, 'folder_hash' => $folder->hash ?? null])); ?>" method="POST">
        <?php echo csrf_field(); ?>
    ...
    <div class="mt-6 text-center">
        <a href="<?php echo e(route('folders.index', ['rpg_hash' => $rpg->hash, 'folder_hash' => $folder->hash ?? null])); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\trall\OneDrive\Documentos\TCC\WEB\QualiaTTRPG\resources\views/folders/create.blade.php ENDPATH**/ ?>