                    ...
                    <div class="flex justify-between items-center py-4">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div class="relative">
                                ...
                                >
                                <img 
                                    src="<?php echo e(Auth::user()->profile_image ? asset('storage/'.Auth::user()->profile_image) : asset('img/profile.png')); ?>" 
                                    alt="Profile" 
                                ...
                                >
                                    <a
                                        href="<?php echo e(route('user.profile', Auth::user()->hash)); ?>"
                        ...
                        <?php else: ?>
                            <div>
                                <a href="<?php echo e(route('login')); ?>" class="text-gray-800 dark:text-white hover:text-blue-500 dark:hover:text-blue-400">
                                    Login
                                </a>
                            </div>
                        <?php endif; ?>
...
<?php /**PATH C:\Users\trall\OneDrive\Documentos\TCC\WEB\QualiaTTRPG\resources\views/layouts/app.blade.php ENDPATH**/ ?>